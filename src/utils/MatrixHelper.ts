export function to2DMatrix(linearMatrix: Float32Array, size: number): number[][] {
...
export function initializeRandomMatrix(size: number, min: number, max: number, step?: number): Float32Array {
